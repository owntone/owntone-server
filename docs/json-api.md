...
Search for artists, albums, tracks by a smart playlist query expression (see [smart-playlists.md](https://github.com/owntone/owntone-server/blob/master/docs/smart-playlists.md) for the expression syntax).
